...
if (localStorage.getItem('listar') == null) {
    ...
    listar.forEach(function(element, index) {
        ...
        html += '<td><button onclick="eliminar('+ index +')" class="btn btn-danger">eliminar</button> <a href="editar.html"><button onclick="Editar('+ index +')" class="btn btn-primary">Editar</button></a></td>';
        html += "</tr>";
    });
